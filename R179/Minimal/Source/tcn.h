...
#define LC_REJECT                     1
#define LC_K_CALLS                    2
#define LC_MVBC01_EMD_NA              3   /* EMD Not implemented for MVBC01 */

#define LC_MAX_UINT16_VAL           (65535U)  /* Maximum 16-bit value */
#define LC_MAX_UINT32_VAL           (4294967295UL)  /* Maximum 32-bit value */
#define LC_MVBC01_ECA_ECB_NA        0x8000  /* ECA & ECB Not implemented for MVBC01 */

#define LC_FC_UINT16_OVERFLOW       0x0001   /* FC 16-bit overflow */
#define LC_FC_UINT32_OVERFLOW       0x0002   /* FC 32-bit overflow */
#define LC_FC_MSK                   0x0003   

#define LC_EC_UINT16_OVERFLOW       0x0004   /* EC 16-bit overflow */
#define LC_EC_UINT32_OVERFLOW       0x0008   /* EC 32-bit overflow */
#define LC_EC_MSK                   0x000C   

#define LC_ECA_UINT16_OVERFLOW      0x0010   /* ECA 16-bit overflow */
#define LC_ECA_UINT32_OVERFLOW      0x0020   /* ECA 32-bit overflow */
#define LC_ECA_MSK                  0x0030   

#define LC_ECB_UINT16_OVERFLOW      0x0040   /* ECB 16-bit overflow */
#define LC_ECB_UINT32_OVERFLOW      0x0080   /* ECB 32-bit overflow */
#define LC_ECB_MSK                  0x00C0   
...
#define LC_MVB_LINE_MODE_ESD	0x0000    /* clear TM_DR_TRAFO */
#define LC_MVB_LINE_MODE_EMD	0x0020	  /* set   TM_DR_TRAFO */
...
struct LC_STR_MVB_COUNTERS
{
	unsigned long fc;                     /* 32-bit Frame Counters   */
	unsigned long ec;                     /* 32-bit Error Counters   */
	unsigned long eca;                    /* 32-bit Line A Err Cntr  */
	unsigned long ecb;                    /* 32-bit Line B Err Cntr  */
...
extern short          _lc_m_set_line_mode          (unsigned short,
                                                    unsigned short);
extern short          _lc_m_get_line_mode          (unsigned short,
                                                    unsigned short *);
extern short          _lc_m_read_counters          (unsigned int,
                                                    struct LC_STR_MVB_COUNTERS* );
extern short          _lc_m_reset_counters         (unsigned int);
...
*/
    ...
    #define lc_m_set_line_mode          _lc_m_set_line_mode
    #define lc_m_get_line_mode          _lc_m_get_line_mode
    #define lc_m_read_counters          _lc_m_read_counters
    #define lc_m_reset_counters         _lc_m_reset_counters
...
#define lc_set_line_mode(a)            lc_m_set_line_mode(0,a)
#define lc_get_line_mode(a)            lc_m_get_line_mode(0,a)
#define lc_read_counters(a)            lc_m_read_counters(0,a)
#define lc_reset_counters()            lc_m_reset_counters(0)
...
typedef union
    ...
    #define tm_mcr_get_rev_idx(mcr)  (((mcr >> 11) & 0x001F) + 1)
...
typedef union
    {
        ...
        {
          #ifdef O_BIGENDIAN
            VOL unsigned int   dmy__ :  2;  /* !!! Unsupported bits */
			VOL unsigned int   ato   :  1;  /* Allow Timeout  - MVBC 02 only */
    ...
    #define TM_DR_ATO    0x2000  /* MVBC 02 only */
...
typedef VOL struct
	...
	VOL TM_TYPE_WORD    eca;   /* + 0x50 */
	    TM_TYPE_WORD    dmy__52;
	VOL TM_TYPE_WORD    ecb;   /* + 0x54 */
	    TM_TYPE_WORD    dmy__56; 
...
extern unsigned int global_ba_bus_id;
...
void    bam_init   (void);
void    bam_init2  (unsigned int bus_id);
...
"Name=BA MVBC TCN:1.6.2.0:06.12.07-D: BA supported on MVB2 "
